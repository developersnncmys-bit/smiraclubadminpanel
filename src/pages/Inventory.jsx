        ...
        <div className="grid gap-4 xl:col-span-2 xl:grid-cols-[minmax(0,1.15fr)_minmax(0,1fr)_minmax(0,1fr)]">
          <section className="card relative overflow-hidden bg-ink-900 p-5 text-white">
            ...
            <div className="relative">
              <p className="text-xs font-bold uppercase tracking-[0.14em] text-white/50">Inventory value</p>
              <p className="num mt-2 font-display text-4xl font-extrabold leading-none">{inr(stockValue)}</p>
