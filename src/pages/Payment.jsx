...
import {
  LayoutDashboard, ArrowLeftRight, PhoneCall, Crown, CalendarCheck, CreditCard,
  FileText as FileIcon, Undo2, Users2, Percent, Receipt as ReceiptIcon, Building2, KeyRound,
} from 'lucide-react';
        ...
        <div className="grid gap-4 xl:col-span-2 xl:grid-cols-[minmax(0,1.15fr)_minmax(0,1fr)_minmax(0,1fr)]">
          <section className="card relative overflow-hidden bg-ink-900 p-5 text-white">
            ...
            <div className="relative">
              <p className="text-xs font-bold uppercase tracking-[0.14em] text-white/50">Total collection</p>
              <p className="num mt-2 font-display text-4xl font-extrabold leading-none">{inr(totalCollection)}</p>
